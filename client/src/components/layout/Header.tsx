...
import { ShoppingCart, Search, User, Menu, X, Heart, ChevronDown, LogOut, Package, Settings } from 'lucide-react'
          ...
          <form onSubmit={handleSearch} className="hidden md:flex flex-1 max-w-xl">
            <div className="relative w-full">
              <input
                ...
                placeholder="Tìm kiếm sản phẩm mẹ và bé..."
                className="w-full pl-4 pr-12 py-2.5 border-2 border-pink-100 rounded-xl focus:outline-none focus:border-primary-400 text-sm bg-pink-50/50"
              />
